...
static YYACTIONTYPE yy_action[] = {
 /*     0 */    27,   19,    1,   41,    8,   16,    5,   17,    8,    6,
 /*    10 */    12,   11,    8,   26,   24,   17,    8,   25,    2,   18,
 /*    20 */     3,    4,    7,   28,    9,   26,   13,   10,   12,   14,
 /*    30 */    30,   15,   29,   33,   22,   27,   20,   21,   31,   23,
 /*    40 */    32,
};
static YYCODETYPE yy_lookahead[] = {
 /*     0 */     1,    2,    7,    8,    1,    2,    9,   10,    1,    2,
 /*    10 */     1,    2,    1,    2,    9,   10,    1,    2,    1,    1,
 /*    20 */     6,    2,   10,    0,    3,   12,    2,   11,    1,    4,
 /*    30 */     0,   11,    0,    2,    6,    1,    7,    1,    0,    2,
 /*    40 */     1,
};
#define YY_SHIFT_USE_DFLT (-2)
static signed char yy_shift_ofst[] = {
 /*     0 */    -1,   17,   18,   19,    3,    7,   23,   -2,   21,    9,
 /*    10 */    -2,   -2,   24,   25,   27,   -2,   30,   -2,   31,   34,
 /*    20 */    36,   18,   37,   11,   15,   32,   38,   39,
};
#define YY_REDUCE_USE_DFLT (-6)
static signed char yy_reduce_ofst[] = {
 /*     0 */    -5,   -6,   14,   -6,   -3,   12,   -6,   -6,   -6,   16,
 /*    10 */    -6,   -6,   -6,   -6,   20,   -6,   -6,   -6,   -6,   29,
 /*    20 */    -6,   28,   -6,    5,   12,   -6,   -6,   -6,
};
static YYACTIONTYPE yy_default[] = {
 /*     0 */    40,   40,   40,   40,   40,   40,   40,   34,   40,   40,
 /*    10 */    36,   37,   40,   39,   40,   38,   40,   35,   40,   40,
...
static const char *yyRuleName[] = {
 ...
 /*   1 */ "request_hdr ::= CRLF method STRING protocol CRLF headers CRLF",
 /*   2 */ "request_hdr ::= method STRING protocol CRLF CRLF",
 /*   3 */ "request_hdr ::= CRLF method STRING protocol CRLF CRLF",
 /*   4 */ "method ::= STRING",
 /*   5 */ "protocol ::= STRING",
 /*   6 */ "headers ::= headers header",
 /*   7 */ "headers ::= header",
 /*   8 */ "header ::= STRING COLON multiline",
 /*   9 */ "header ::= STRING COLON CRLF",
 /*  10 */ "multiline ::= STRING CRLF TAB multiline",
 /*  11 */ "multiline ::= STRING CRLF",
};
#endif /* NDEBUG */
...
static void yy_destructor(YYCODETYPE yymajor, YYMINORTYPE *yypminor){
  switch( yymajor ){
    ...
    */
    ...
    case 3:
    case 4:
#line 25 "../../src/http_req_parser.y"
{ buffer_free((yypminor->yy0)); }
#line 344 "http_req_parser.c"
      break;
...
#line 593 "http_req_parser.c"
  yy_destructor(2,&yymsp[-6].minor);
  yy_destructor(2,&yymsp[-2].minor);
        /* No destructor defined for headers */
  yy_destructor(2,&yymsp[0].minor);
        break;
      case 2:
#line 61 "../../src/http_req_parser.y"
{
    http_req *req = ctx->req;
...
#line 609 "http_req_parser.c"
  yy_destructor(2,&yymsp[-1].minor);
  yy_destructor(2,&yymsp[0].minor);
        break;
      case 3:
#line 76 "../../src/http_req_parser.y"
{
    http_req *req = ctx->req;
...
#line 671 "http_req_parser.c"
      ...
      case 7:
        ...
        break;
      case 8:
#line 128 "../../src/http_req_parser.y"
{
    http_req *req = ctx->req;

    if (NULL == (yygotominor.yy15 = (data_string *)array_get_unused_element(req->headers, TYPE_STRING))) {
    ...
    buffer_pool_append(ctx->unused_buffers, yymsp[0].minor.yy17); 
      
    array_insert_unique(req->headers, (data_unset *)yygotominor.yy15);
}
#line 696 "http_req_parser.c"
  ...
  yy_destructor(2,&yymsp[0].minor);
        break;
      case 10:
#line 145 "../../src/http_req_parser.y"
{
...
#line 713 "http_req_parser.c"
  yy_destructor(2,&yymsp[-2].minor);
  yy_destructor(4,&yymsp[-1].minor);
        break;
      case 11:
#line 154 "../../src/http_req_parser.y"
{
   yygotominor.yy17 = yymsp[-1].minor.yy0;

   yymsp[-1].minor.yy0 = NULL;
}
#line 724 "http_req_parser.c"
  yy_destructor(2,&yymsp[0].minor);
        break;
  };
...
static void yy_parse_failed(
  ...
  ** parser fails */
#line 15 "../../src/http_req_parser.y"

  ctx->ok = 0;

#line 758 "http_req_parser.c"
