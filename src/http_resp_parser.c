...
static YYACTIONTYPE yy_action[] = {
 /*     0 */    10,   35,    3,    5,    1,    9,    7,   17,   20,   13,
 /*    10 */    16,   15,    5,   19,    5,   26,    6,   22,    4,    2,
 /*    20 */    23,    6,    8,   11,   21,   24,   25,   12,   24,   24,
 /*    30 */    24,   14,   18,
};
static YYCODETYPE yy_lookahead[] = {
 /*     0 */     5,    6,    1,    2,    9,    1,    2,    1,    2,    1,
 /*    10 */     2,    1,    2,    1,    2,    2,    3,    2,    9,    8,
 /*    20 */     0,    3,    1,    7,    2,    0,    0,   10,   11,   11,
 /*    30 */    11,    8,    8,
};
#define YY_SHIFT_USE_DFLT (-1)
static signed char yy_shift_ofst[] = {
 /*     0 */    15,   -1,    1,   20,   -1,   18,    4,   21,   -1,   -1,
 /*    10 */    22,    6,    8,   -1,   10,   25,   -1,   -1,   12,   26,
 /*    20 */    -1,   -1,   13,
};
#define YY_REDUCE_USE_DFLT (-6)
static signed char yy_reduce_ofst[] = {
 /*     0 */    -5,   11,    9,   -6,   -6,   -6,   -6,   -6,   -6,   -6,
 /*    10 */    16,   17,   -6,   23,    9,   -6,   -6,   24,    9,   -6,
 /*    20 */    -6,   -6,   -6,
};
static YYACTIONTYPE yy_default[] = {
 /*     0 */    34,   31,   34,   34,   30,   34,   34,   34,   32,   33,
 /*    10 */    34,   34,   34,   31,   34,   34,   29,   31,   34,   34,
 /*    20 */    28,   27,   34,
};
...
static const char *yyRuleName[] = {
 /*   0 */ "response_hdr ::= header headers CRLF",
...
static void yy_destructor(YYCODETYPE yymajor, YYMINORTYPE *yypminor){
  switch( yymajor ){
    ...
    */
    ...
    case 2:
    case 3:
#line 25 "../../src/http_resp_parser.y"
{ buffer_free((yypminor->yy0)); }
#line 338 "http_resp_parser.c"
      break;
    case 10:
#line 24 "../../src/http_resp_parser.y"
{ buffer_free((yypminor->yy0)); }
#line 343 "http_resp_parser.c"
      break;
...
static void yy_reduce(
  ...
  */
      case 0:
#line 28 "../../src/http_resp_parser.y"
{
...
#line 606 "http_resp_parser.c"
  yy_destructor(1,&yymsp[-2].minor);
        /* No destructor defined for headers */
  yy_destructor(1,&yymsp[0].minor);
        break;
      case 2:
#line 63 "../../src/http_resp_parser.y"
{
    http_resp *resp = ctx->resp;
...
#line 620 "http_resp_parser.c"
  yy_destructor(1,&yymsp[-2].minor);
        /* No destructor defined for headers */
  yy_destructor(1,&yymsp[0].minor);
        break;
      case 3:
#line 71 "../../src/http_resp_parser.y"
{
...
#line 640 "http_resp_parser.c"
        break;
      case 4:
#line 85 "../../src/http_resp_parser.y"
{
    char *err;
...
#line 656 "http_resp_parser.c"
        break;
      case 5:
#line 98 "../../src/http_resp_parser.y"
{
    yygotominor.yy0 = yymsp[0].minor.yy0;
}
#line 663 "http_resp_parser.c"
        break;
      case 6:
#line 102 "../../src/http_resp_parser.y"
{
...
#line 675 "http_resp_parser.c"
      ...
      case 8:
        break;
      case 9:
#line 114 "../../src/http_resp_parser.y"
{
    http_resp *resp = ctx->resp;
...
#line 699 "http_resp_parser.c"
  yy_destructor(3,&yymsp[-2].minor);
  yy_destructor(1,&yymsp[0].minor);
        break;
      case 10:
#line 130 "../../src/http_resp_parser.y"
{
    http_resp *resp = ctx->resp;
...
static void yy_parse_failed(
  ...
  ** parser fails */
#line 15 "../../src/http_resp_parser.y"

  ctx->ok = 0;

#line 753 "http_resp_parser.c"
